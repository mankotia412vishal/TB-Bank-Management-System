...
def Intro():
	...
	print("\t\t\t===================================================")
	print("\t\t\t===================================================")
	print(Back.RED+"\t\t\t\t   Bank  Management System ")
	print("\t\t\t\t          Group9 ")
	# cout << "\n\n\n\t\t\t\t\tVersion : 1.1"
	print("\t\t\t===================================================")
	print("\t\t\t===================================================")
...
def Student():
	...
	print("\t\t\t===================================================")
	# print(Back.RED+"\n\n\t\t\t\t Student Details")
	print("\t\t\t\t\t  51 : Rohant Narang ")
	print("\t\t\t\t\t  64 : Vedika Jumbad")
	print("\t\t\t\t\t  65 : Vishal Singh ")
	print("\t\t\t\t\t  66 : Pallavi Wasade")
	print("\t\t\t\t\t  68 : Sakshi Zod")
...
def Guide():
	...
	print("\t\t\t===================================================")
	print("\t\t\t===================================================")
	print("\t\t\t\t  Teacher : Prof.Amruta  Mam  ")
	print("\t\t\t \t Institute : Vishwakarma University ")
	# cout << "\n\n\n\t\t\t\t\tVersion : 1.1"
	print("\n\t\t\t===================================================")
	print("\t\t\t===================================================")
	print("\n\n\n\n\n")
